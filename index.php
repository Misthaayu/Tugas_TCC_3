...
<header> <!--Section HEADER-->
	<div class="logo">
		<h1>STMIK AKAKOM</h1>
		<h4>Menciptakan Sarjana Berkualitas</h4>
	</div>
	<div class="navigasi">
			<ul>
...
Saat ini program sarjana mempunyai program stusi Teknik Informatika dan Sistem Informasi dengan status akreditasi B dan pada program diploma mempunyai 3 program studi yaitu Manajemen Informatika (status Akreditasi B), Teknik Komputer(status Akreditasi B), dan Komputerisasi Akuntansi (status Akreditasi B).
Dosen
	...
	<div class="sidebar">
		<div class="padding_this">
			...
			<ul>
				...
				<li><a href="#">Komputerisasi Akuntansi</a></li>
				<li><a href="#">Teknik Komputer</a></li>
				<li><a href="#">Management Akuntasi</a></li>
			</ul>
		</div>
	</div>
</main>
...
<footer> <!--Section FOOTER-->
	<div class="footer">
		<small>&copy; Copyright - Akakom 2018 </small>
	</div>
</footer>
